...
---
= 在NetApp Console中管理StorageGRID 的已知问题
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[[updated-display-names-dont-appear-in-the-netapp-console]]
== 更新后的显示名称未出现在NetApp Console中

如果您使用重命名过程为站点或网格定义新的显示名称，则新的显示名称不会反映在NetApp Console中。在NetApp Console中，系统继续显示系统名称而不是新的显示名称。
